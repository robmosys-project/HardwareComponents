...
#ifndef ZEDCAMERA_EXTENSION_HH_
#define ZEDCAMERA_EXTENSION_HH_
...
public:
	ZedCameraExtension(const std::string &name);
	virtual ~ZedCameraExtension();
