...
ZedCameraImpl::ZedCameraImpl(const std::string &componentName, int & argc, char ** argv)
:	SmartACE::SmartComponent(componentName, argc, argv)
{  }

ZedCameraImpl::ZedCameraImpl(const std::string &componentName, int & argc, char ** argv, const ACE_Sched_Params &sched_params)
:	SmartACE::SmartComponent(componentName, argc, argv, NULL, sched_params)
{  }

ZedCameraImpl::~ZedCameraImpl() 
{  }

int ZedCameraImpl::startComponentInfrastructure(void)
{
...
void ZedCameraImpl::stopComponentInfrastructure(const std::chrono::steady_clock::duration &timeoutTime)
{
	this->signalSmartTasksToStop(timeoutTime);
}
void ZedCameraImpl::cleanUpComponentResources()
{
